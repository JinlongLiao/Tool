...
public class SocketToolController extends SocketToolView {
  private static final Logger log = org.slf4j.LoggerFactory.getLogger(SocketToolController.class);
  ...
  public SocketToolService getSocketToolService() {
    return this.socketToolService;
  }

  public ObservableList<Map<String, String>> getServerConnectTableData() {
    return this.serverConnectTableData;
  }

  public String[] getAutoReplyTypeStrings() {
    return this.autoReplyTypeStrings;
  }

  public void setSocketToolService(SocketToolService socketToolService) {
    this.socketToolService = socketToolService;
  }

  public void setServerConnectTableData(ObservableList<Map<String, String>> serverConnectTableData) {
    this.serverConnectTableData = serverConnectTableData;
  }

  public void setAutoReplyTypeStrings(String[] autoReplyTypeStrings) {
    this.autoReplyTypeStrings = autoReplyTypeStrings;
  }
}
