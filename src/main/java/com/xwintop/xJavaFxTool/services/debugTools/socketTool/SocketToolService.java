...
public class SocketToolService {
  private static final Logger log = org.slf4j.LoggerFactory.getLogger(SocketToolService.class);
...
//        acceptor.getFilterChain().addLast("codec", new ProtocolCodecFilter(new PrefixedStringCodecFactory(Charset.forName("UTF-8"))));
  ...
  public SocketToolController getSocketToolController() {
    return this.socketToolController;
  }
  ...
  public void setSocketToolController(SocketToolController socketToolController) {
    this.socketToolController = socketToolController;
  }

  public void setTcpAcceptor(IoAcceptor tcpAcceptor) {
    this.tcpAcceptor = tcpAcceptor;
  }

  public void setUdpAcceptor(IoAcceptor udpAcceptor) {
    this.udpAcceptor = udpAcceptor;
  }
